<script lang="ts">
  let {
    ...
    href: string;
    label: string;
    icon: 'home' | 'agents' | 'skills' | 'artifacts' | 'connectors' | 'workflows' | 'settings';
    active?: boolean;
    expandable?: boolean;
    collapsed?: boolean;
  }>();
...
>
  <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    {:else if icon === 'agents'}
      ...
      <path d="M9.5 9.5h.01M14.5 9.5h.01M9 14.5c1.8 1.4 4.2 1.4 6 0" />
    {:else if icon === 'skills'}
      <path d="m13 2-9 12h7l-1 8 10-13h-7z" />
    {:else if icon === 'artifacts'}
      <rect x="3" y="5" width="18" height="15" rx="2" />
      <path d="M7 9h.01M11 9h6M7 13h10M7 17h6" />
    {:else if icon === 'connectors'}
      <rect x="3" y="3" width="7" height="7" rx="1" />
      <rect x="14" y="14" width="7" height="7" rx="1" />
      <path d="M10 6.5h4a3.5 3.5 0 0 1 3.5 3.5v4M6.5 10v4A3.5 3.5 0 0 0 10 17.5h4" />
    {:else if icon === 'workflows'}
      <rect x="3" y="3" width="6" height="6" rx="1" />
      <rect x="15" y="15" width="6" height="6" rx="1" />
      <path d="M9 6h3a3 3 0 0 1 3 3v6M6 9v6a3 3 0 0 0 3 3h6" />
